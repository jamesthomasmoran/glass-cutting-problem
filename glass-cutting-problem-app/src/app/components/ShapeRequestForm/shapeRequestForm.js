...
class ShapeRequestForm extends React.Component {
  constructor(props) {
    ...
    this.setErrosState = this.setErrorsState.bind(this)
  }
        ...
        <div className="accordion" id="shapeRequestForm">
                ...
                <div id="collapseShapes" className="collapse show" aria-labelledby="shapes" data-parent="#shapeRequestForm">
                    <div className=" row card-body">
                        <div className="col-md-8 mr-3">
                            <ShapeDisplay setShapesState={this.setShapesState} setErrorsState={this.setErrorsState} shapes={this.state.shapes} errors={this.state.errors}/>
                        </div>
            ...
            <div className="card">
                <div className="card-header" id="algorithmParameters">
                    <AlgorithmParameterForm></AlgorithmParameterForm>
                </div>
            </div>
        </div>
  </div>
